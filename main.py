...
"""
pip install git+https://github.com/Langchain/langchain.git@v0.0.340
pip install git+https://github.com/Langchain/langchain_experimental.git@v0.0.42
pip install git+https://github.com/streamlit/streamlit.git@1.28.1
pip install git+https://github.com/google-research/google-generativeai.git@v0.2.2
pip install git+https://github.com/astanin/python-tabulate.git@0.9.0
